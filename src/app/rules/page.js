  ...
  return (
    <>
      ...
      <div className={styles.container} data-aos="fade-up">
        <p>
           رایحه ی خوش” ضمن احترامی که برای حریم شخصی کاربران قائل است، برای خرید،
          ...
          مورد نیاز است و از آنجا که کلیه فعالیت‌های رایحه ی خوش قانونی و مبتنی بر
          ...
          گرفتن سفارش وارد کنند و رایحه ی خوش تنها برای ارسال همان سفارش، از این
          اطلاعات استفاده خواهد کرد.همچنین رایحه ی خوش ممکن است برای ارتباط با
          ...
          باشند، می‌توانند عضویت دریافت خبرنامه رایحه ی خوش را در پروفایل خود لغو
          کنند.{" "}
        </p>
        <p>
        رایحه ی خوش  ممکن است نقد و نظرهای ارسالی کاربران را در راستای رعایت قوانین
          وب سایت ویرایش کند. همچنین اگر نظر یا پیام ارسال شده توسط کاربر، مشمول
          مصادیق محتوای مجرمانه باشد،  رایحه ی خوش  می‌تواند از اطلاعات ثبت شده برای
          ...
          شخص دیگری فاش کنند.رایحه ی خوش  هویت شخصی کاربران را محرمانه می‌داند و
          اطلاعات شخصی آنان را به هیچ شخص یا سازمان دیگری منتقل نمی‌کند، مگر
          اینکه با حکم قانونی مجبور باشد در اختیار مراجع ذی‌صلاح قرار دهد.رایحه ی خوش 
           همانند سایر وب سایت‌ها از جمع آوری IP و کوکی‌ها استفاده می‌کند، اما
          پروتکل، سرور و لایه‌های امنیتی رایحه ی خوش  و روش‌های مناسب مدیریت داده‌ها
          اطلاعات کاربران را محافظت و از دسترسی‌های غیر قانونی جلوگیری
          می‌کند. رایحه ی خوش  برای حفاظت و نگهداری اطلاعات و حریم شخصی کاربران همه
          توان خود را به کار می‌گیرد و امیدوار است که تجربه‌ی خریدی امن، راحت و
          خوشایند را برای همه کاربران فراهم آورد.  {" "}
        </p>
        <p>
          در صورتی که تمایلی به دریافت ایمیل‌ها و خبرنامه های  رایحه ی خوش  ندارید٬ می
        ...
        <p>تلفن تماس و فکس: 33515100-045 <strong>(پاسخگویی طی ساعات کاری)</strong></p>
      </div>
      <Footer />
    </>
  );
